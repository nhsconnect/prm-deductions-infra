locals {
  cost_usage_access_logs_prefix = "cost_usage/"
}
...
/* TODO PRMT-4479
    ...
    pre-prod-ehr-ingestion
    prm-deductions-pre-prod-terraform-state
    prm-deductions-pre-prod-terraform-state-store

    pre-prod-cost-and-usage-access-logs
    pre-prod-ehr-repo-access-logs
    pre-prod-ehr-transfer-service-sqs-large-messages-access-logs
    pre-prod-repo-load-balancer-access-logs
*/
