...
def getSSMParameter(parameterName):
...
if not region:
    region = cfg['Region']
senderEmailSsmParameter = cfg['Sender_Email_Ssm_Parameter']
recipientEmailSsmParameter = cfg['Recipient_Email_Ssm_Parameter']
sender = getSSMParameter(senderEmailSsmParameter)['Parameter']['Value']
recipient = getSSMParameter(recipientEmailSsmParameter)['Parameter']['Value']
